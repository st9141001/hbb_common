...
lazy_static::lazy_static! {
    ...
    pub static ref APP_NAME: RwLock<String> = RwLock::new("Tako".to_owned());
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["tako-st9141001.duckdns.org"];
pub const RS_PUB_KEY: &str = "DN38crbAkdO6YTtmtKpNJmRpPx4ZWIFRxjXo2hXRqY0=";
